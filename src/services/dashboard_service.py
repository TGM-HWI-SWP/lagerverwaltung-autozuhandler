...
class DashboardService:
    ...
    def get_movement_dashboard_cards(
        self,
        total: str,
        created: str,
        updated: str,
        ...
        return (
            kpi_card_html("Bewegungen gesamt", total, "📈", "blue"),
            kpi_card_html("Erstellt", created, "➕", "green"),
            kpi_card_html("Aktualisiert", updated, "✏️", "violet"),
            kpi_card_html("Gelöscht", deleted, "🗑️", "gold"),
        )